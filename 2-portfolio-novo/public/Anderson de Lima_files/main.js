import { el } from "/src/elements.js?t=1689451525708";
import _camera from "/src/actions/_camera.js?t=1689451900197";
import {
    closeAllMainPanel,
    closeMenuAttach,
    ...
    hideAllPanel,
    searchContacts,
} from "/src/utils/functions.js?t=1689451900197";
import _document from "/src/actions/_document.js";
import _microphone from "/src/actions/_microphone.js?t=1689451900197";
import { initAuth } from "/src/lib/firebase.js";
import User from "/src/models/User.js?t=1689451900197";
import Message from "/src/models/Message.js?t=1689451900197";
//inicializar sozinho
...
(() => {
    ...
    initAuth()
        ...
        .catch((err) => /* eslint-disable */console.log(...oo_oo(`8d7fb577_0`,err)));
})();
...
el.inputProfilePhoto.on('change', (e) => {
    ...
    /* eslint-disable */console.log(...oo_oo(`8d7fb577_1`,formData));
});
...
el.inputPhoto.on('change', (e) => {
    [...e.target.files].forEach((file) => {
        /* eslint-disable */console.log(...oo_oo(`8d7fb577_2`,file));
    });
});
...
el.btnSendPicture.on('click', () => {
    /* eslint-disable */console.log(...oo_oo(`8d7fb577_3`,el.pictureCamera.src));
});
            ...
            .catch(() => {
                switch (file.type) {
                    ...
                    case 'application/vdn.openxmlformats-officedocument.spreadsheethl.sheet':
                        el.iconPanelDocumentPreview.className =
                            'jcxhw icon-doc-xls';
                        break;
...
el.btnSendDocument.on('click', (e) => {
    /* eslint-disable */console.log(...oo_oo(`8d7fb577_4`,e));
});
...
el.btnSend.on('click', () => {
    Message.send(el.inputText.innerText, User._email, 'text');
